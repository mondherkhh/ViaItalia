...
const Toast = styled.div`
  ...
  font-size: 0.9rem;
  font-weight: 600;
  box-shadow: 0 8px 32px rgba(19,138,91,0.24);
  z-index: 9999;
  display: flex;
  align-items: center;
  gap: 0.75rem;
...
color: var(--text);
  ...
  &::placeholder { color: var(--text); opacity: 0.72; }

  &:focus {
    border-color: rgba(19,138,91,0.45);
    background: rgba(19,138,91,0.04);
    box-shadow: 0 0 0 3px rgba(19,138,91,0.08);
  }
`;
...
const SubmitBtn = styled.button`
  ...
  text-transform: uppercase;
  cursor: pointer;
  box-shadow: 0 4px 24px rgba(19,138,91,0.25);
  transition: transform 0.2s ease, box-shadow 0.2s ease;

  &:hover {
    transform: translateY(-3px);
    box-shadow: 0 10px 36px rgba(19,138,91,0.35);
  }
