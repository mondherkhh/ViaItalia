...
const FOOTER = styled.footer`
  background:
    radial-gradient(circle at 15% 50%, rgba(19, 138, 91, 0.05), transparent 40%),
    radial-gradient(circle at 85% 50%, rgba(201, 52, 62, 0.04), transparent 40%),
    var(--background);
  padding: 5rem 0 0 0;
  position: relative;
  overflow: hidden;
...
const TopLine = styled.div`
  ...
  background: linear-gradient(90deg,
    transparent,
    rgba(19, 138, 91, 0.28) 30%,
    rgba(201, 52, 62, 0.22) 70%,
    transparent
  );
`;
