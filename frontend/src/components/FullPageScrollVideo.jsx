...
const Stage = styled.div`
  ...
  height: 100vh;
  overflow: hidden;
  background: var(--page-background, #f1f3f2);
...
const Overlay = styled.div`
  ...
  pointer-events: none;
  background:
    linear-gradient(90deg, rgba(255, 255, 255, 0.86), rgba(255, 255, 255, 0.52) 46%, rgba(255, 255, 255, 0.78)),
    linear-gradient(180deg, rgba(255, 255, 255, 0.72), transparent 30%, rgba(255, 255, 255, 0.84));

  body.theme-dark & {
    background:
      linear-gradient(90deg, rgba(5, 13, 16, 0.84), rgba(10, 18, 29, 0.52) 46%, rgba(19, 9, 14, 0.82)),
      linear-gradient(180deg, rgba(5, 13, 16, 0.72), transparent 30%, rgba(10, 12, 22, 0.86));
  }
`;
