...
export const DashboardContainer = styled.div`
  ...
  position: relative;
  overflow-x: hidden;
  color: var(--client-text, #e8eef7);
  background: var(--client-bg, #071321);
  background-image: var(--client-bgGradient, radial-gradient(circle at 85% 5%, rgba(24, 92, 135, .12), transparent 32%), linear-gradient(180deg, #071321 0%, #091727 100%));
  transition: background 0.3s ease, color 0.3s ease;

  /* Light Mode: keep every dashboard label and value readable in deep black. */
  body.theme-light &,
  body.theme-light & * {
  ...
  &::after {
    ...
    position: absolute;
    inset: 0;
    background: var(--client-overlay, linear-gradient(90deg, rgba(4, 12, 22, .2), transparent 35%, rgba(10, 27, 44, .16)));
    pointer-events: none;
  }
`;
...
export const LoadingSpinner = styled.div`
  ...
  border: ${props => props.borderWidth || '4px'} solid ${props => props.color || 'var(--client-border, rgba(255, 255, 255, 0.3))'};
  border-top: ${props => props.borderWidth || '4px'} solid ${props => props.spinColor || 'var(--client-text, #111111)'};
  border-radius: 50%;
...
export const EmptyContainer = styled.div`
  ...
  padding: 2rem;
  text-align: center;
  color: var(--client-muted, rgba(91, 104, 115, 0.75));
`;
...
export const CardContainer = styled.div`
  background: var(--client-card, rgba(255, 255, 255, 0.1));
  backdrop-filter: blur(10px);
  border: 1px solid var(--client-border, rgba(255, 255, 255, 0.2));
  border-radius: ${props => props.borderRadius || '16px'};
  padding: ${props => props.padding || '1.5rem'};
  transition: all 0.3s ease;
  box-shadow: 0 8px 32px var(--client-shadow, rgba(0, 0, 0, 0.1));
...
export const ModalContainer = styled.div`
  background: var(--client-card, rgba(255, 255, 255, 0.95));
  backdrop-filter: blur(20px);
  border: 1px solid var(--client-border, rgba(255, 255, 255, 0.3));
