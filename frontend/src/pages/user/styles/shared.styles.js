...
export const Button = styled.button`
  background: ${props => {
    ...
    if (props.variant === 'secondary') return 'var(--client-surfaceSoft, rgba(255, 255, 255, 0.2))';
  ...
  color: var(--client-text, #ffffff);
  border: ${props => props.variant === 'secondary' ? '1px solid var(--client-border, rgba(255, 255, 255, 0.3))' : 'none'};
...
export const LinkButton = styled.button`
  ...
  color: ${props => props.color || 'var(--client-text, #ffffff)'};
  border: none;
  padding: 0;
  font-size: ${props => props.fontSize || '1rem'};
...
export const Input = styled.input`
  ...
  &::placeholder {
    color: var(--client-muted, rgba(255, 255, 255, 0.6));
  }
  
  &:focus {
    outline: none;
    border-color: ${props => props.focusColor || '#667eea'};
    background: var(--client-card, rgba(255, 255, 255, 0.15));
...
export const Select = styled.select`
  ...
  option {
    background: var(--client-surface, #764ba2);
    color: var(--client-text, #ffffff);var(--client-text, #ffffff);
  }
...
export const LoadingBar = styled.div`
  width: 100%;
  height: 4px;
  background: var(--client-border, rgba(255, 255, 255, 0.2));
  border-radius: 2px;
  overflow: hidden;
  position: relative;
