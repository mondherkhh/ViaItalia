...
export const ContentSubtitle = styled.p`
  font-size: 1.1rem;
  color: var(--client-muted, rgba(255, 255, 255, 0.8));
  margin: 0;
  line-height: 1.5;
...
export const ContentLoadingSpinner = styled.div`
  width: 50px;
  height: 50px;
  border: 4px solid var(--client-border, rgba(255, 255, 255, 0.3));
  border-top: 4px solid var(--client-text, #ffffff);
  border-radius: 50%;
...
export const ContentErrorSubMessage = styled.div`
  color: var(--client-muted, rgba(255, 255, 255, 0.7));
  font-size: 0.9rem;
  margin-top: 0.5rem;
`;
