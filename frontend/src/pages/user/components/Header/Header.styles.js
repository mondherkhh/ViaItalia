...
export const HeaderContainer = styled.header`
  ...
  right: 0;
  height: 96px;
  background: var(--client-surface, #071321);
  color: var(--client-text, #e8eef7);
  border-bottom: 1px solid var(--client-border, #13263a);
  border-radius: 0;
  z-index: 1000;
...
export const ThemeToggle = styled.button`
  ...
  border: 1px solid var(--client-border, #21364c);
  border-radius: 12px;
  background: var(--client-surfaceSoft, #0d1c2d);
  color: var(--client-text, #e8eef7);
  font-size: 0.82rem;
  font-weight: 700;
  cursor: pointer;
...
export const NotificationButton = styled.button`
  ...
  width: 48px;
  height: 48px;
  background: ${props => props.hasUnread ? 'rgba(23, 155, 92, .18)' : 'var(--client-surfaceSoft, #0d1c2d)'};
  border: 1px solid var(--client-border, #21364c);
  border-radius: 14px;
  display: flex;
  align-items: center;
...
export const UserDropdown = styled.div`
  ...
  right: 0;
  width: 200px;
  background: var(--client-surfaceSoft, rgba(255, 255, 255, 0.08));
  color: var(--client-text, #e8eef7);
  backdrop-filter: blur(25px);
  border: 1px solid var(--client-border, rgba(255, 255, 255, 0.15));
  border-radius: 12px;
...
export const MobileMenu = styled.div`
  ...
  background: var(--client-surface, rgba(30, 30, 40, 0.95));
  color: var(--client-text, #e8eef7);
  backdrop-filter: blur(10px);
  border: 1px solid var(--client-border, rgba(255, 255, 255, 0.1));
  border-radius: 16px;
  margin: 0.5rem;
  padding: 1.5rem;
