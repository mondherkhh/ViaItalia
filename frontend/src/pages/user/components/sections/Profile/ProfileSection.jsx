...
const ProfileSection = () => {
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{
              width: '40px',
              height: '40px',
              border: '3px solid var(--client-border, #d9e1de)',
  ...
  return (
    <ProfileContainer>
      <ProfileHeader>
        <ProfileTitle>
          <><FiUser className="inline-block mr-2 align-middle" size={22} aria-hidden="true" />Mon Profil</>
        </ProfileTitle>
        <ProfileSubtitle>
                  ...
                  <ImagePreviewContainer>
                    ...
                    <div style={{ flex: 1 }}>
                      <p style={{ 
                        ...
                        {imagePreview 
                          ? <><FiCheckCircle className="inline-block mr-1 align-middle" size={16} aria-hidden="true" />Photo mise à jour</>
