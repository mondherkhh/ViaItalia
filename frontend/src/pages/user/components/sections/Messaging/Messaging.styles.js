...
export const MessagingContainer = styled.div`
  ...
  /* All other Messaging content stays white in both modes. */
  &&.messaging-root,
  &&.messaging-root * {
  ...
  &&.messaging-root input::placeholder,
  &&.messaging-root textarea::placeholder {
    color: #ffffff !important;
    -webkit-text-fill-color: #ffffff !important;
    opacity: 1 !important;
  }

  /* Only the pictured empty state is black in both modes. */
  &&.messaging-root .messaging-empty-black,
  &&.messaging-root .messaging-empty-black * {
    color: #111111 !important;
    -webkit-text-fill-color: #111111 !important;
  }

  /* Only the message composer input is black in both modes. */
  &&.messaging-root input[aria-label="Message"] {
    color: #111111 !important;
    -webkit-text-fill-color: #111111 !important;
  }

  &&.messaging-root input[aria-label="Message"]::placeholder {
    color: #111111 !important;
    -webkit-text-fill-color: #111111 !important;
    opacity: 1 !important;
  }
...
export const MessageBubble = styled.div`
  ...
  color: ${props => props.isOwn 
    ? '#ffffff' 
    : props.isDarkMode ? '#ffffff' : '#111111'};
...
export const SendButton = styled.button`
  ...
  /* Keep the send icon black in both themes. */
  & svg,
  & svg * {
    color: #111111 !important;
...
export const AttachButton = styled.button`
  ...
  /* Keep the attachment icon black in both themes. */
  & svg,
  & svg * {
    color: #111111 !important;
    stroke: #111111 !important;
...
export const DarkModeButton = styled.button`
  ...
  color: ${props => props.isDarkMode ? 'var(--client-text, #111111)' : '#667eea'};
  cursor: pointer;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const MobileDarkModeLabel = styled.div`
  ...
  align-items: center;
  gap: 0.5rem;
  color: ${props => props.isDarkMode ? 'var(--client-text, #111111)' : '#111111'};
  font-size: 0.875rem;
  font-weight: 500;
