...
import { FiCalendar, FiCheck, FiClock, FiLock, FiMessageCircle, FiPaperclip, FiX } from 'react-icons/fi';
...
const MessagingSection = () => {
  ...
  if (!user) {
    return (
      <MessagingContainer className="messaging-root">
        <ChatContainer>
          <ChatHeader>
            <ChatTitle>
          ...
          <MessagesContainer>
            <EmptyStateContainer>
              <EmptyStateIcon><FiLock size={32} aria-hidden="true" /></EmptyStateIcon>
      ...
      <MessageItem key={message.id} isOwn={isOwn}>
        <MessageBubble isOwn={isOwn}>
          ...
          {message.fileName && (
            <div style={{ 
              ...
              <FiPaperclip size={16} aria-hidden="true" /> {message.fileName}
              {message.fileSize && (
        ...
        {isOwn && (
          <MessageStatus isOwn={isOwn}>
            {message.seen ? <><FiCheck size={14} aria-hidden="true" /><FiCheck size={14} aria-hidden="true" /></> : message.delivered ? <FiCheck size={14} aria-hidden="true" /> : <FiClock size={14} aria-hidden="true" />}
          </MessageStatus>
        )}
      </MessageItem>
    );
  ...
  const renderEmptyState = () => (
    <EmptyStateContainer className="messaging-empty-black">
      <EmptyStateIcon><FiMessageCircle size={32} aria-hidden="true" /></EmptyStateIcon>
  ...
  return (
    <MessagingContainer className="messaging-root" isDarkMode={isDarkMode}>
      <ChatContainer isDarkMode={isDarkMode}>
        ...
        <MessageInputContainer isDarkMode={isDarkMode}>
          ...
          {attachedFile && (
            <FileAttachment>
              <FileAttachmentInfo>
                <FiPaperclip size={16} aria-hidden="true" /> {attachedFile.name}
                {attachedFile.size && (
        ...
        <ContactBody>
          <ContactSection>
            ...
            <ContactItem>
              ...
              <ContactContent>
                <ContactItemLabel><FiCalendar className="inline-block mr-2 align-middle" size={16} aria-hidden="true" />Horaires</ContactItemLabel>
            ...
            <ContactItem>
              ...
              <ContactContent>
                <ContactItemLabel><FiClock className="inline-block mr-2 align-middle" size={16} aria-hidden="true" />Heures</ContactItemLabel>
            ...
            <ContactItem>
              ...
              <ContactContent>
                <ContactItemLabel><FiClock className="inline-block mr-2 align-middle" size={16} aria-hidden="true" />Temps de réponse moyen</ContactItemLabel>
